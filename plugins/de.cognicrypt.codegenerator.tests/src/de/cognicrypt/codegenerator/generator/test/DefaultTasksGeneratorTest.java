...
//	}
	...
	public void SECMUPACOMPDefault() {
		this.configSecMPComp = TestUtils.createConfigurationForCodeGeneration(this.developerProject,
				this.secMPCompTask);
	...
	public void HybridEncryptionDefault() {
		this.configHybridEnc = TestUtils.createConfigurationForCodeGeneration(this.developerProject,
				this.hybridEncTask);
		final boolean hybridEncryptionCheck = this.generatorHybridEnc.generateCodeTemplates(this.configHybridEnc,
				this.hybridEncTask.getAdditionalResources());
