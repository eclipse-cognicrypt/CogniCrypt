...
//	public CompareAlgorithmPage(final InstanceGenerator inst, final TaskSelectionPage taskSelectionPage, ConfiguratorWizard confWizard) {
...
//		this.taskSelectionPage = taskSelectionPage;
	...
	public void createControl(final Composite parent) {
		...
		algorithmClass.addSelectionChangedListener(event -> {
			...
			setValue(CompareAlgorithmPage.this.instanceGenerator.getInstances().get(b));
			CompareAlgorithmPage.this.instanceDetails.setText(getInstanceProperties(CompareAlgorithmPage.this.instanceGenerator.getInstances().get(b)));
...
//		this.instancePropertiesPanel.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
		...
		//Button to compare the algorithm in the Java project
				...
				compareAlgorithmButton.addListener(SWT.Selection, new Listener() {
				      public void handleEvent(Event event) {
//				    	  CompareAlgorithmPage window=new CompareAlgorithmPage(instanceGenerator, taskSelectionPage, configuratorWizard);
//				    	  WizardDialog dialog = new WizardDialog(parent,	 CompareAlgorithmPage(instanceGenerator, taskSelectionPage, configuratorWizard));
//				    	  dialog.open();
//				    	  window.createControl(parent);
//				    	  Display display = Display.getDefault();
//				    	  compAlgoPage.createControl(parent);
//				    	  test.main();;
				    	  WizardDialog dialog = new WizardDialog(getShell(), configuratorWizard);
				    	  dialog.open();
				        }
				      });
