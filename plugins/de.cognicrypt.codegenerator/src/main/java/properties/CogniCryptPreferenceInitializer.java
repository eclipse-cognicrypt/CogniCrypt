...
public class CogniCryptPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences(){
		...
		store.setDefault(ICogniCryptConstants.PRE_COMBO, -1);
		...
		store.setDefault(ICogniCryptConstants.PRE_ADV_COMBO1,-1);
//		store.setDefault(ICogniCryptConstants.PRE_ADV_COMBO2,0);
		store.setDefault(ICogniCryptConstants.PRE_ADV_COMBO3,-1);
