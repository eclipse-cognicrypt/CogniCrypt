scope({c0_DSS:2, c0_DSSProperty:3, c0_Enum:9, c0_Performance:4, c0_Security:5, c0_keysize:2, c0_performance:2, c0_security:2});
defaultScope(1);
intRange(-8, 7);
stringLength(27);
...
c0_keysize = c0_DSS.addChild("c0_keysize").withCard(1, 1);
...
c1_keysize = c0_DigitalSignatures.addChild("c1_keysize").withCard(1, 1);
...
c1_keysize.refToUnique(Int);
c0_DigitalSignatures.addConstraint(equal(joinRef(join($this(), c1_keysize)), joinRef(join(joinRef(join($this(), c0_scheme)), c0_keysize))));
