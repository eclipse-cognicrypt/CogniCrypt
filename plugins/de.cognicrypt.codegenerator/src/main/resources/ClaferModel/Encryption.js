...
c0_OAEPWithSHA256AndMGF1Padding = Clafer("c0_OAEPWithSHA256AndMGF1Padding").withCard(1, 1);
...
c0_OAEPWithSHA256AndMGF1Padding.extending(c0_AsymmetricPadding);
...
c0_RSA.addConstraint(implies(greaterThan(joinRef(join($this(), c0_keySizePub)), constant(2048)), and(and(equal(joinRef(join($this(), c1_performance)), global(c0_Slow)), equal(joinRef(join($this(), c0_algorithmSecurity)), global(c0_Strong))), equal(joinRef(join($this(), c1_padding)), global(c0_OAEPWithSHA256AndMGF1Padding)))));
