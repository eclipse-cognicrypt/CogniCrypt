scope({c0_Algorithm:5, c0_AsymmetricPadding:2, c0_Cipher:3, c0_Enum:20, c0_Mode:7, c0_Padding:2, c0_Performance:4, c0_Security:4, c0_SymmetricBlockCipher:2, c0_SymmetricCipher:2, c0_algorithmSecurity:5, c0_classPerformance:5, c0_description:5, c0_keySize:2, c0_mode:2, c0_name:5, c0_padding:2, c0_performance:5, c0_provider:5});
defaultScope(1);
intRange(-8, 7);
stringLength(43);
...
c0_OAEPWithSHA1 = Clafer("c0_OAEPWithSHA1").withCard(1, 1);
...
c0_AsymmetricCiphers = Clafer("c0_AsymmetricCiphers").withCard(1, 1).withGroupCard(1, 1);
c0_RSA = c0_AsymmetricCiphers.addChild("c0_RSA").withCard(0, 1);
c0_HybridEncryption = Clafer("c0_HybridEncryption").withCard(1, 1);
c0_symmetricCipher = c0_HybridEncryption.addChild("c0_symmetricCipher").withCard(1, 1);
c0_asymmetricCipher = c0_HybridEncryption.addChild("c0_asymmetricCipher").withCard(1, 1);
c0_security = c0_HybridEncryption.addChild("c0_security").withCard(1, 1);
...
c0_OAEPWithSHA1.extending(c0_AsymmetricPadding);
Constraint(implies(some(global(c0_OAEPWithSHA1)), equal(joinRef(global(c0_OAEPWithSHA1)), constant("\"OAEPWithSHA-1AndMGF1Padding\""))));
...
c0_AsymmetricCiphers.addConstraint(equal(joinRef(join(join($this(), c0_RSA), c0_name)), constant("\"RSA\"")));
c0_AsymmetricCiphers.addConstraint(equal(joinRef(join(join($this(), c0_RSA), c0_description)), constant("\"RSA Algorithm\"")));
c0_AsymmetricCiphers.addConstraint(equal(joinRef(join(join($this(), c0_RSA), c1_mode)), global(c0_ECB)));
c0_AsymmetricCiphers.addConstraint(or(equal(joinRef(join(join($this(), c0_RSA), c0_keySizePub)), constant(2048)), equal(joinRef(join(join($this(), c0_RSA), c0_keySizePub)), constant(4096))));
c0_AsymmetricCiphers.addConstraint(implies(equal(joinRef(join(join($this(), c0_RSA), c0_keySizePub)), constant(2048)), and(and(equal(joinRef(join(join($this(), c0_RSA), c1_performance)), global(c0_Slow)), equal(joinRef(join(join($this(), c0_RSA), c0_algorithmSecurity)), global(c0_Medium))), equal(joinRef(join(join($this(), c0_RSA), c1_padding)), global(c0_OAEPWithSHA1)))));
c0_AsymmetricCiphers.addConstraint(implies(greaterThan(joinRef(join(join($this(), c0_RSA), c0_keySizePub)), constant(2048)), and(and(equal(joinRef(join(join($this(), c0_RSA), c1_performance)), global(c0_Slow)), equal(joinRef(join(join($this(), c0_RSA), c0_algorithmSecurity)), global(c0_Strong))), equal(joinRef(join(join($this(), c0_RSA), c1_padding)), global(c0_OAEPWithSHA256)))));
c0_AsymmetricCiphers.addConstraint(equal(joinRef(join(join($this(), c0_RSA), c0_keySizeSec)), joinRef(join(join($this(), c0_RSA), c0_keySizePub))));
c0_HybridEncryption.extending(c0_Task);
c0_HybridEncryption.addConstraint(equal(joinRef(join($this(), c1_description)), constant("\"HybridEncryption\"")));
