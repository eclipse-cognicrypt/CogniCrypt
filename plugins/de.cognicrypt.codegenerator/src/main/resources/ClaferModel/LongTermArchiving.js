scope({c0_AddingDocuments:2, c0_Enum:11, c0_List:4, c0_NumberDocuments:2, c0_TrustedAuthorities:3});
defaultScope(1);
intRange(-8, 7);
stringLength(24);
...
c0_Both = Clafer("c0_Both").withCard(1, 1);
...
c0_security = c0_LongTermArchiving.addChild("c0_security").withCard(1, 1);
...
c0_Both.extending(c0_TrustedAuthorities);
c0_description.refTo(string);
c0_LongTermArchiving.extending(c0_Task);
c0_LongTermArchiving.addConstraint(equal(joinRef(join($this(), c0_description)), constant("\"Securely Archive Files\"")));
...
c0_LongTermArchiving.addConstraint(equal(joinRef(join($this(), c0_security)), constant(1)));
c0_LongTermArchiving.addConstraint(implies(equal(joinRef(join($this(), c0_addDoc)), global(c0_MultipleTimes)), equal(joinRef(join($this(), c0_list)), global(c0_Skip_List))));
...
c0_LongTermArchiving.addConstraint(implies(and(and(equal(joinRef(join($this(), c0_numDoc)), global(c0_Single)), equal(joinRef(join($this(), c0_addDoc)), global(c0_Once))), equal(joinRef(join($this(), c0_trust)), global(c0_SignatureBased))), equal(joinRef(join($this(), c0_list)), global(c0_Simple_List))));
c0_LongTermArchiving.addConstraint(implies(and(and(equal(joinRef(join($this(), c0_numDoc)), global(c0_Single)), equal(joinRef(join($this(), c0_addDoc)), global(c0_Once))), or(equal(joinRef(join($this(), c0_trust)), global(c0_Both)), equal(joinRef(join($this(), c0_trust)), global(c0_Notaries)))), equal(joinRef(join($this(), c0_list)), global(c0_Notarial_Attestation_Wrapper))));
