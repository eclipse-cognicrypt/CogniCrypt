scope({c0_Algorithm:4, c0_Cipher:2, c0_Enum:18, c0_Mode:7, c0_Padding:2, c0_Performance:4, c0_Security:4, c0_SymmetricBlockCipher:2, c0_SymmetricCipher:2, c0_algorithmSecurity:4, c0_classPerformance:4, c0_description:4, c0_keySize:2, c0_mode:2, c0_name:4, c0_padding:2, c0_performance:4, c0_provider:4});
defaultScope(1);
intRange(-8, 7);
stringLength(43);
...
c0_security = c0_SymmetricEncryption.addChild("c0_security").withCard(1, 1);
...
c0_SymmetricBlockCipher.addConstraint(implies(or(equal(joinRef(join($this(), c0_mode)), global(c0_CBC)), equal(joinRef(join($this(), c0_mode)), global(c0_PCBC))), notEqual(joinRef(join($this(), c0_padding)), global(c0_NoPadding))));
c0_SymmetricBlockCipher.addConstraint(implies(or(or(equal(joinRef(join($this(), c0_mode)), global(c0_CTR)), equal(joinRef(join($this(), c0_mode)), global(c0_CFB))), equal(joinRef(join($this(), c0_mode)), global(c0_OFB))), equal(joinRef(join($this(), c0_padding)), global(c0_NoPadding))));
...
c0_cipher.refToUnique(c0_SymmetricBlockCipher);
