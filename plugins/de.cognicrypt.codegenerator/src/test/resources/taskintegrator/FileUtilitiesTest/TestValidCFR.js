...
c0_Test = Clafer("c0_Test").withCard(1, 1);
c0_cipher = c0_Test.addChild("c0_cipher").withCard(1, 1);
c0_security = c0_Test.addChild("c0_security").withCard(1, 1);
...
c0_Test.extending(c0_Task);
c0_Test.addConstraint(equal(joinRef(join($this(), c1_description)), constant("\"Encrypt Data Using a Secret Key\"")));
