...
public class BrowseFilePopUp extends Dialog {
	...
	BrowseFilePopUp(final Shell parentShell, PageForTaskIntegratorWizard pageForTaskIntegratorWizard, CompositeChoiceForModeOfWizard compositeChoiceForModeOfWizard) {
		super(parentShell);
    ...
    protected Point getInitialSize() {
        return new Point((int) (1000/*windowSize.getWidth()*0.3*/), (int) (300/*windowSize.getHeight()*0.2*/)); // 1000, 350
    }
