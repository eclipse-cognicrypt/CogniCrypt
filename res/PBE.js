scope({c0_Algorithm:7, c0_Cipher:3, c0_Digest:3, c0_SymmetricBlockCipher:3, c0_SymmetricCipher:3, c0_Task:2, c0_blockSize:3, c0_insecure:7, c0_keySize:3, c0_memory:3, c0_name:7, c0_outputSize:3, c0_performance:7, c0_secure:7, c0_status:7, c1_name:2});
defaultScope(1);
intRange(-8, 7);
stringLength(34);
...
c0_Pass.addConstraint(equal(joinRef(join($this(), c1_name)), constant("\"test\"")));
