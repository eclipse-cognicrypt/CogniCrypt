...
c0_ABE.addConstraint(equal(joinRef(join($this(), c0_abe)), global(c0_ABECipherTextPolicy)));
c0_ABE.addConstraint(equal(joinRef(join($this(), c0_abe)), global(c0_ABEKeyIndexPolicy)));
