...
c0_Encrypt = Clafer("c0_Encrypt").withCard(1, 1).extending(c0_Task);
c0_Type = c0_Encrypt.addChild("c0_Type").withCard(1, 1).withGroupCard(1, 1);
c0_PS = c0_Type.addChild("c0_PS").withCard(0, 1);
c0_PBE = c0_Type.addChild("c0_PBE").withCard(0, 1);
...
c0_PS.refTo(c0_PasswordStoring);
c0_PBE.refTo(c0_PasswordBasedEncryption);
...
c0_Encrypt.addConstraint(equal(joinRef(join($this(), c0_Description)), constant("\"Password Storing\"")));
c0_PS.addConstraint(equal(joinRef(join(joinParent(joinParent($this())), c0_Description)), constant("\"Password Storing\"")));
c0_PBE.addConstraint(equal(joinRef(join(joinParent(joinParent($this())), c0_Description)), constant("\"Encrypt data based on a password\"")));
