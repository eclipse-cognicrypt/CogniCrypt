scope({c0_Algorithm:8, c0_Cipher:2, c0_CipherSuite:0, c0_Digest:3, c0_Enum:14, c0_KeyDerivationAlgorithm:3, c0_Mode:3, c0_Padding:2, c0_Performance:4, c0_Security:4, c0_SymmetricBlockCipher:2, c0_SymmetricCipher:2, c0_Task:3, c0_cipher:0, c0_description:8, c0_digest:3, c0_iterations:3, c0_keySize:2, c0_mode:2, c0_name:8, c0_outputSize:3, c0_padding:2, c0_performance:8, c0_provider:8, c0_security:8, c1_description:3, c1_digest:0, c1_outputSize:3});
defaultScope(1);
intRange(-8, 7);
stringLength(48);
...
c0_cipher = c0_CipherSuite.addChild("c0_cipher").withCard(1, 1);
c1_digest = c0_CipherSuite.addChild("c1_digest").withCard(1, 1);
c0_Ciphers = Clafer("c0_Ciphers").withCard(1, 1);
c0_AES = c0_Ciphers.addChild("c0_AES").withCard(1, 1);
c0_DES = c0_Ciphers.addChild("c0_DES").withCard(1, 1);
...
c0_CipherSuite.extending(c0_Algorithm);
c0_cipher.refToUnique(c0_SymmetricCipher);
c1_digest.refToUnique(c0_Digest);
