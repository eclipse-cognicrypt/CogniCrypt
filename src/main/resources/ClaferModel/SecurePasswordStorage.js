...
c0_sha_128.addConstraint(equal(joinRef(join($this(), c0_security)), joinRef(global(c0_Medium))));
c0_sha_128.addConstraint(equal(joinRef(join($this(), c0_performance)), joinRef(global(c0_Slow))));
