scope({c0_Algorithm:3, c0_Cipher:3, c0_Enum:14, c0_Mode:4, c0_Padding:2, c0_Performance:4, c0_Security:4, c0_SymmetricBlockCipher:3, c0_SymmetricCipher:3, c0_classPerformance:3, c0_description:3, c0_keySize:3, c0_mode:3, c0_name:3, c0_padding:3, c0_performance:3, c0_security:3});
defaultScope(1);
intRange(-8, 7);
stringLength(43);
...
c0_SymmetricBlockCipherAlgorithms = Clafer("c0_SymmetricBlockCipherAlgorithms").withCard(1, 1).withGroupCard(1, 1);
c0_AES128 = c0_SymmetricBlockCipherAlgorithms.addChild("c0_AES128").withCard(0, 1);
c0_AES192 = c0_SymmetricBlockCipherAlgorithms.addChild("c0_AES192").withCard(0, 1);
c0_AES256 = c0_SymmetricBlockCipherAlgorithms.addChild("c0_AES256").withCard(0, 1);
