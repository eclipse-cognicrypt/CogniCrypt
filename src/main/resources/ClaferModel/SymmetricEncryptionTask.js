scope({c0_Algorithm:4, c0_Cipher:2, c0_Enum:20, c0_Mode:7, c0_Padding:2, c0_Performance:4, c0_Provider:3, c0_Security:4, c0_SymmetricBlockCipher:2, c0_SymmetricCipher:2, c0_classPerformance:4, c0_description:4, c0_keySize:2, c0_mode:2, c0_name:4, c0_padding:2, c0_performance:4, c0_provider:2, c0_security:4});
defaultScope(1);
intRange(-8, 7);
stringLength(43);
...
c0_SUNJCE = Clafer("c0_SUNJCE").withCard(1, 1);
c0_BOUNCYCASTLE = Clafer("c0_BOUNCYCASTLE").withCard(1, 1);
...
c0_provider = c0_SymmetricBlockCipher.addChild("c0_provider").withCard(1, 1);
...
c0_SUNJCE.extending(c0_Provider);
c0_BOUNCYCASTLE.extending(c0_Provider);
...
c0_DES.addConstraint(notEqual(joinRef(join($this(), c0_provider)), global(c0_BOUNCYCASTLE)));
