...
c0_CipherSuite = Abstract("c0_CipherSuite").extending(c0_Algorithm);
...
c0_Medium = Clafer("c0_Medium").withCard(1, 1).extending(c0_Security);
...
c0_NoPadding = Clafer("c0_NoPadding").withCard(1, 1).extending(c0_Padding);
c0_PKCS5Padding = Clafer("c0_PKCS5Padding").withCard(1, 1).extending(c0_Padding);
c0_ECB = Clafer("c0_ECB").withCard(1, 1).extending(c0_Mode);
c0_CBC = Clafer("c0_CBC").withCard(1, 1).extending(c0_Mode);
c0_OFB = Clafer("c0_OFB").withCard(1, 1).extending(c0_Mode);
