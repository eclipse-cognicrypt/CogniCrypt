scope({c0_Algorithm:7, c0_Cipher:3, c0_Description:7, c0_Digest:3, c0_Fast:7, c0_HighSecurity:7, c0_LowSecurity:7, c0_MediumSecurity:7, c0_Slow:7, c0_SymmetricBlockCipher:3, c0_SymmetricCipher:3, c0_Task:3, c0_VeryFast:7, c0_keySize:3, c0_memory:3, c0_name:7, c0_outputSize:3, c0_performance:7, c0_security:7, c1_Description:3});
defaultScope(1);
intRange(-8, 7);
stringLength(48);
...
c0_AES128.addConstraint(equal(joinRef(join($this(), c0_name)), constant("\"AES encryption with 128bit key\"")));
...
c0_AES256.addConstraint(equal(joinRef(join($this(), c0_name)), constant("\"AES encryption with 256bit key\"")));
...
c0_DES.addConstraint(equal(joinRef(join($this(), c0_name)), constant("\"DES encryption\"")));
...
c0_sha_1.addConstraint(equal(joinRef(join($this(), c0_name)), constant("\"SHA-1 digest\"")));
...
c0_pbkdf.addConstraint(equal(joinRef(join($this(), c0_name)), constant("\"PBKDF2 key derivation\"")));
