...
c0_PasswordEncryption = Clafer("c0_PasswordEncryption").withCard(1, 1).extending(c0_Task);
c0_kda = c0_PasswordEncryption.addChild("c0_kda").withCard(1, 1);
c0_digest = c0_PasswordEncryption.addChild("c0_digest").withCard(1, 1);
c0_cipher = c0_PasswordEncryption.addChild("c0_cipher").withCard(1, 1);
c0_Password = Clafer("c0_Password").withCard(1, 1).extending(c0_Task);
c1_kda = c0_Password.addChild("c1_kda").withCard(1, 1);
c0_Encryption = Clafer("c0_Encryption").withCard(1, 1).extending(c0_Task);
c1_cipher = c0_Encryption.addChild("c1_cipher").withCard(1, 1);
c0_PASS = Clafer("c0_PASS").withCard(1, 1);
c0_MAINTASK = c0_PASS.addChild("c0_MAINTASK").withCard(1, 1);
...
c0_MAINTASK.refTo(c0_PasswordEncryption);
...
c0_PasswordEncryption.addConstraint(equal(joinRef(join($this(), c0_Description)), constant("\"Encrypt data based on a password\"")));
c0_Password.addConstraint(equal(joinRef(join($this(), c0_Description)), constant("\"kda\"")));
c0_Encryption.addConstraint(equal(joinRef(join($this(), c0_Description)), constant("\"cipher\"")));
