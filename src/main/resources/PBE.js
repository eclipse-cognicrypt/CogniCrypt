...
c0_EncryptionUsingCipher = Clafer("c0_EncryptionUsingCipher").withCard(1, 1).extending(c0_Task);
c0_cipher = c0_EncryptionUsingCipher.addChild("c0_cipher").withCard(1, 1);
...
c0_EncryptionUsingCipher.addConstraint(equal(joinRef(join($this(), c0_Description)), constant("\"Encrypt data using Asymmetric key\"")));
