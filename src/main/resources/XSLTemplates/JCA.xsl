...
<xsl:if test="//task/algorithm[@type='AttributeBasedCipher']/name = 'Cipher Text Policy'">
...
<xsl:if test="//task/algorithm[@type='AttributeBasedCipher']/name = 'Key Index Policy'">
