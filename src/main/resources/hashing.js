...
c0_PasswordStoring.addConstraint(lessThan(joinRef(join(joinRef(join($this(), c0_digestToUse)), c0_performance)), constant(3)));
c0_PasswordStoring.addConstraint(greaterThan(joinRef(join(joinRef(join($this(), c0_digestToUse)), c0_outputSize)), constant(510)));
c0_PasswordStoring.addConstraint(or(some(join($this(), c0_kdaToUse)), some(join($this(), c0_digestToUse))));
c0_PasswordStoring.addConstraint(lessThan(joinRef(join(joinRef(join($this(), c0_kdaToUse)), c0_performance)), constant(3)));
