scope({c0_Algorithm:17, c0_Digest:13, c0_HMAC:0, c0_KeyDerivationAlgorithm:3, c0_digest:0, c0_insecure:17, c0_name:17, c0_outputSize:13, c0_performance:17, c0_secure:17, c0_status:17});
defaultScope(1);
intRange(-8, 7);
stringLength(18);
...
c0_MAC = Abstract("c0_MAC").extending(c0_Algorithm);
c0_HMAC = Abstract("c0_HMAC").extending(c0_MAC);
...
c0_digest = c0_HMAC.addChild("c0_digest").withCard(1, 1);
